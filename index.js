...
app.get('/', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      'GET /api/status/image?address=xxx': 'Render server status as PNG',
      'POST /api/status/image': 'Render server status as PNG (JSON body)',
      'GET /server/motd/image?address=xxx': 'Render ScKey compatible MOTD status as PNG',
